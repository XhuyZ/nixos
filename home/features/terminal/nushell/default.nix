    ...
    programs.nushell = {
      ...
      configFile.text = ''
                                ...
                                #update system
                                      ...
                                      alias xhuyz-lydra = sudo nixos-rebuild switch --flake .#lydra
                                ...
                                #service
                                      ...
                                      alias tlp-stop = sudo systemctl stop tlp
                											alias orion-unlock = cryptsetup-askpass
        															alias incus-preseed = sudo systemctl restart incus-preseed.service
                                #dotnetrun
                                      alias dr = dotnet run
                                ...
                                # start postgres docker
                                      alias psqldocker = sudo docker run --name postgres -e POSTGRES_PASSWORD=Wenhui35@ -p 5432:5432 -d postgres
                        							alias update-nixivm = nix flake lock --update-input my-nixvim
      '';
    };
  };
}
