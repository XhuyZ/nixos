    ...
    wayland.windowManager.mango = {
      ...
      settings = ''
                        						...
                        						urgentcolor=0xdc322fff
                        											...
                        											bind=SUPER,F5,brightnessctl set 5%-
                        											bind=SUPER,F5,brightnessctl set 5%-
        					bind=SUPER,F2,wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+
        					bind=SUPER,F3,wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%-
        					bind=SUPER,F1,wpctl set-mute   @DEFAULT_AUDIO_SINK@ toggle
